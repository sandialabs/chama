...
def test_path_sensor_time_limited():
    path_sensor = chama.sensors.Path()
    path_sensor.locations = [[0,0,0], [1,0,0], [1,3,0], [1,2,1]]
    path_sensor.speed = 1
    path_sensor.camera = None
    path_sensor.sampling_times = [1,2]
    path_sensor.repeat = False
...
def test_path_sensor_extra_time():
    path_sensor = chama.sensors.Path()
    path_sensor.locations = [[0,0,0], [1,0,0], [1,3,0], [1,2,1]]
    path_sensor.speed = 1
    path_sensor.camera = None
    path_sensor.sampling_times = [1,2,6]
    path_sensor.repeat = False
